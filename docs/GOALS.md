...
#### Week 1: REST API Enhancement
- [ ] Add JSON request/response handling
- [ ] Create a simple CRUD API (User or Product entity)
- [ ] Implement proper error handling
- [ ] Add request validation
- [ ] Write integration tests

**Deliverable**: A functional REST API with create, read, update, delete operations
